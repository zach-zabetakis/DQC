...
internals.Spell.prototype.castOutside = function castOutside(scenario, member, targets, RNG) {
  var messages = [];
  var message  = '';
  var target;
...
internals.Spell.prototype.castRadiant = function castRadiant(scenario, member, targets, RNG) {
  var message = '';
...
internals.Spell.prototype.castRepel = function castRepel(scenario, member, targets, RNG) {
  var messages = [];
  var message  = '';
  var target;
...
internals.Spell.prototype.castReturn = function castReturn(scenario, member, targets, RNG) {
  var messages = [];
  var message  = '';
  var target
