...
module.exports = {
  ...
  performPreBattleCommand  : performPreBattleCommand,
  performPostBattleCommand : performPostBattleCommand,
  warp                     : warp
};
...
// perform the specified command before any in-battle action occurs
function performPreBattleCommand (DQC, scenario, command) {
...
// perform the specified command after any in-battle action occurs
function performPostBattleCommand (DQC, scenario, command) {
