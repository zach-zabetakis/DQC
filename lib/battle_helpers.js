...
function applyStatus (status, member) {
  ...
  if (_.includes(statuses, status)) {
    ...
    switch (status) {
      case 'BO':
        message = 'A shining wall of light appears before ' + member.displayName();
        break;
      case 'CF':
        message = 'Confused!';
        break;
      ...
      case 'FR':
        ...
        break;
      case 'IR':
        message = member.displayName() + ' becomes a lump of iron!';
        break;
      case 'NU':
        message = 'Paralyzed!';
        break;
...
// remove all battle-only statuses and spell effects
