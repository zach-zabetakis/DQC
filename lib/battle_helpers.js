...
function checkPlink (member, target) {
  var plink;

  if (member.is_enemy) {
    plink = member.curr_attack < (2 + target.curr_defense);
  } else {
    plink = member.curr_attack < (2 + parseInt(target.curr_defense / 2, 10));
  }
