...
function performCommand (DQC, scenario, member) {
  ...
  switch (type) {
    ...
    case 'spell':
      // TODO
      message = dispName + ' is casting a spell!';
      break;
    case 'heart':
      // TODO
      message = dispName + ' uses heart powers!';
      break;
    case 'item':
      // TODO
      message = dispName + ' is using an item!';
      break;
    case 'run':
      // TODO
      ...
      break;
    case 'parry':
      // the damage protection from parry is applied at the start of the turn
      message = dispName + ' is on guard!';
      break;
    case 'charge':
      // TODO
      message = dispName + ' charges ahead!';
      break;
    case 'retreat':
      // TODO
      message = dispName + ' falls back!';
      break;
    case 'switch':
      // TODO
      message = dispName + ' switches groups!';
      break;
    case 'none':
      message = dispName + ' is assessing the situation.';
      break;
    default:
  ...
  if (hasTurn && _.includes(character.status, 'CF')) {
    switch (DQC.RNG.integer(1, 4)) {
      case 1:
        ...
        message += character.name + ' snaps out of confusion!';
        break;
      default:
  ...
  if (hasTurn && _.includes(monster.status, 'CF')) {
    switch (DQC.RNG.integer(1, 4)) {
      case 1:
        ...
        message += disp_name + ' snaps out of confusion!';
        break;
      case 2:
      ...
      case 3:
        ...
        break;
      case 4:
        message += disp_name + ' ' + (monster.flavor.confusion || 'is flustered!');
        break;
      default:
