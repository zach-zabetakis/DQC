...
module.exports = function (battleHelpers) {
  ...
  return {
    ...
    commandBedragon      : commandBedragon,
    confusionSpell       : confusionSpell,
    ...
    while (!isValid) {
      ...
      switch (member.behavior) {
        case 'custom':
          ...
          logicFunction = 'logic' + member.name;
  ...
  // logic for a user under the effects of BeDragon
  function commandBedragon (DQC, scenario, member) {
  ...
  function confusionSpell (DQC, scenario, member) {
